    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if scaleLevel != nil {
            ...
            if let scaleLevel = scaleLevel {
                ...
                print("tutorialComplete \(tutorialComplete)")
...
//            //this setup should really go in in view did load
                ...
                struct buttonText {
                    ...
                    var progress: Float
//                    var id: String
                    init(iheader: String, isubtext: String, iprogress: Float) {
                        header = iheader
                        subtext = isubtext
                        progress = iprogress
//                        id = iid
        ...
        //                styler!.setupMenuButton(ibutton: button!, ititle: buttonInfo[i].header, isubtext: buttonInfo[i].subtext, iprogressAmount: -1.0)
                ...
                var buttonTextInfo = buttonText(iheader: key.uppercased(), isubtext: returnLevelStr(ilc: lc, ikey: key, ilevel: level), iprogress: progress)
        
                styler.setupMenuButtonAttributes(ibutton: Button0,
                                                 isubText: menuButtonSubtext[0],
                                                 iprogressBar: menuButtonProgress[0],
                                                 ibuttonActive: true,
                                                 ibuttonStr: buttonTextInfo.header,
                                                 isubTextStr: buttonTextInfo.subtext,
                                                 iprogressAmount: buttonTextInfo.progress
                )
                                       
                                       
//                                       ititle: key.uppercased(),
//                                       isubtext: returnLevelStr(ilc: lc, ikey: key, ilevel: level),
//                                       iprogressAmount: progress)
//
...
//                styler!.setupMenuButton(ibutton: button!, ititle: buttonInfo[i].header, isubtext: buttonInfo[i].subtext, iprogressAmount: -1.0)
        ...
        styler.setupMenuButton(ibutton: Button0, isubText: menuButtonSubtext[0], iprogressBar: menuButtonProgress[0])
